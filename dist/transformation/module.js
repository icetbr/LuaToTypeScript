...
exports.canBeTransformedToModule = void 0;
const helper = require("./helper");
function canBeTransformedToModule(statements, chunk) {
    ...
    if (firstStatement && firstStatement.type === "LocalStatement") {
        ...
        if (tag) {
            ...
            if (!remainingStatements.some((statement) => {
...
exports.canBeTransformedToModule = canBeTransformedToModule;
